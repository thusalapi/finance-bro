...
import { DASHBOARD_TEST_IDS } from "@/utils/testIds";
...
export default function DashboardPage() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setDashboardData({
        ...
        upcomingGoals:
          upcomingGoals.filter((goal: any) => !goal.completed).slice(0, 3) ||
          [],
  ...
  if (!user) {
    return (
      <div className="flex justify-center p-8">Redirecting to login...</div>
    );
  }
  ...
  if (isLoading) {
    return (
      <div
        ...
        data-testid={DASHBOARD_TEST_IDS.dashboardLoading}
      >
  ...
  return (
    <div className="space-y-6" data-testid={DASHBOARD_TEST_IDS.dashboardPage}>
      {/* Welcome Header */}
      <div className="flex flex-col md:flex-row md:justify-between md:items-center">
        <h1
          className="text-2xl font-bold"
          data-testid={DASHBOARD_TEST_IDS.dashboardTitle}
        >
          Welcome, {user.name}!
        </h1>
        <Button
          onClick={() => router.push("/transactions/new")}
          testId={DASHBOARD_TEST_IDS.newTransactionButton}
        >
          New Transaction
        </Button>
      </div>
      ...
      <div
        ...
        data-testid={DASHBOARD_TEST_IDS.financialSummarySection}
      >
        <div
          className="bg-white rounded-lg shadow p-6"
          data-testid={DASHBOARD_TEST_IDS.incomeCard}
        >
          ...
          <p
            ...
            data-testid={DASHBOARD_TEST_IDS.incomeValue}
          >
        ...
        <div
          className="bg-white rounded-lg shadow p-6"
          data-testid={DASHBOARD_TEST_IDS.expensesCard}
        >
          <h2 className="text-lg font-medium text-gray-900 mb-2">
            Total Expenses
          </h2>
          <p
            ...
            data-testid={DASHBOARD_TEST_IDS.expensesValue}
          >
        ...
        <div
          className="bg-white rounded-lg shadow p-6"
          data-testid={DASHBOARD_TEST_IDS.totalBalanceCard}
        >
          <h2 className="text-lg font-medium text-gray-900 mb-2">
            Net Cashflow
          </h2>
          <p
            ...
            data-testid={DASHBOARD_TEST_IDS.totalBalanceValue}
          >
            $
            {(
              (dashboardData?.totalIncome || 0) -
      ...
      <div
        className="bg-white rounded-lg shadow p-6"
        data-testid={DASHBOARD_TEST_IDS.recentTransactionsSection}
      >
        <div className="flex justify-between items-center mb-4">
          ...
          <Button
            ...
            testId={DASHBOARD_TEST_IDS.viewAllTransactionsButton}
          >
            View All
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div
          className="bg-white rounded-lg shadow p-6"
          data-testid={DASHBOARD_TEST_IDS.budgetSummarySection}
        >
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-gray-900">
              Active Budgets
            ...
            <Button
              ...
              testId={DASHBOARD_TEST_IDS.viewAllBudgetsButton}
            >
              View All
            </Button>
          </div>
        ...
        <div
          className="bg-white rounded-lg shadow p-6"
          data-testid={DASHBOARD_TEST_IDS.upcomingBillsSection}
        >
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-gray-900">
              Financial Goals
            ...
            <Button
              ...
              testId={DASHBOARD_TEST_IDS.viewAllGoalsButton}
            >
              View All
            </Button>
          </div>
